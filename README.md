...
## Struktura projekta
1. data direktorijum sadrži ulazne podatke, kao i kreirani csv fajl u fazi preprocesiranja podataka
2. docs direktorijum sadrži dokumentaciju, koja se sastoji od inicijalnog opisa skupa podataka i izveštaja u PDF formatu
3. feature_reduction je python paket koji sadrži klasu InterpretableFeatureReducer koja može kao transformator da se koristi u okviru pipeline-a
